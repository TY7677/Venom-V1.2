...
bot = telebot.TeleBot('6601668746:AAG6BLLqsoVKKcKOPr9lmQajR_zs26H21qI')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        if len(command) > 2:
            ...
            if user_to_add not in allowed_user_ids:
                ...
                if set_approval_expiry_date(user_to_add, duration, time_unit):
                    response = f"User {user_to_add} added  for {duration} {time_unit}. Access will expire on {user_approval_expiry[user_to_add].strftime('%Y-%m-%d %H:%M:%S')} 👍."
                else:
        ...
        response = "You have not purchased yet purchase now from:- @LOLOLOLOLOLO90087."
...
def clear_users_command(message):
    ...
    if user_id in admin_id:
        ...
        response = "ꜰʀᴇᴇ ᴋᴇ ᴅʜᴀʀᴍ ꜱʜᴀʟᴀ ʜᴀɪ ᴋʏᴀ ᴊᴏ ᴍᴜ ᴜᴛᴛʜᴀ ᴋᴀɪ ᴋʜɪ ʙʜɪ ɢᴜꜱ ʀʜᴀɪ ʜᴏ ʙᴜʏ ᴋʀᴏ ꜰʀᴇᴇ ᴍᴀɪ ᴋᴜᴄʜ ɴʜɪ ᴍɪʟᴛᴀ ʙᴜʏ:- @LOLOLOLOLOLO90087 🙇."
    bot.reply_to(message, response)
...
Buy From :- @LOLOLOLOLOLO90087
Official Channel :- https://t.me/+cmIWWOoaXtIxNGRl
'''
...
✅BUY :- https://t.me/+cmIWWOoaXtIxNGRl'''
    bot.reply_to(message, response)
